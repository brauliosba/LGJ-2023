...
namespace Timers
{
    ...
    public class Timer
    {
        ...
        [SerializeField]private bool m_bIsPaused = false;
        ...
        public Timer(float Interval, UnityAction UnityAction)
        {
            if (m_Interval < 0)
                m_Interval = 0;
        ...
        public Timer(float Interval,float elapsed, UnityAction UnityAction)
        {
            if (m_Interval < 0)
                m_Interval = 0;
        ...
        /// <summary>
        /// Get total elapsed time from 0 to 1 or INFINITE 
        /// </summary>
        public float ElapsedNormalizedTime() { return (m_LoopsCount == INFINITE) ? INFINITE : (m_ElapsedTime / (m_LoopsCount * m_Interval)); }
        ...
        /// <summary>
        /// Get elapsed time in current loop from 0 to 1
        /// </summary>
        public float CurrentCycleElapsedNormalizedTime() { return m_CurrentCycleElapsedTime / m_Interval; }
